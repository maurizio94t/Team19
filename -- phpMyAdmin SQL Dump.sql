...
--
-- Host: localhost:8889
-- Generation Time: Lug 17, 2015 alle 12:23
...
INSERT INTO `Prenotazioni` (`Cod`, `DataP`, `Nome`, `Cognome`, `CF`, `DataN`, `Tel`, `DataI`, `DataF`, `CodPt`) VALUES
(1, '2015-07-16', 'Alessandro', 'Campanello', 'SASDADASA', '2015-06-16', '0805031871', '2015-07-26', '2015-07-31', 9),
(3, '1990-01-01', 'nome', 'cognome', 'cf', '1990-01-01', '123', '1990-01-01', '1990-01-01', 1),
(4, '2015-07-19', 'Maurizio', 'Troiani', 'TRNMRZ94H13A662Q', '1900-01-01', '3405818726', '2015-07-17', '2015-07-19', 1),
(5, '0000-00-00', 'Maurizio', 'Troiani', 'TRNMRZ94H13A662Q', '1900-01-01', '3405818726', '2015-07-17', '2015-07-19', 1),
(6, '2015-07-17', 'Maurizio', 'Troiani', 'TRNMRZ94H13A662Q', '1900-01-01', '3405818726', '2015-07-17', '2015-07-19', 1),
(7, '2015-07-17', 'Maurizio', 'Troiani', 'TRNMRZ94H13A662Q', '1900-01-01', '3405818726', '2015-07-17', '2015-07-19', 1),
(8, '2015-07-17', 'Maurizio', 'Troiani', 'TRNMRZ94H13A662Q', '1994-06-13', '3405818726', '2015-07-18', '2015-07-19', 1);
...
(5, 'cbnello', 'f10e2821bbbea527ea02200352313bc059445190', 'Alessandro', 'cbnelo@live.it');
...
--
ALTER TABLE `Prenotazioni`
  MODIFY `Cod` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `Utenti`
  MODIFY `id_utente` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
