...
<div id="container">
    ...
    <div id="sidebar">
		...
		<ul>
        	<li><a href="#">Trulli di Alberobello</a></li>
            <li><a href="#">Putignano</a></li>
            <li><a href="#">Grotte di Castellana</a></li>
            <li><a href="#">CampannelloTown</a></li>
        </ul>
	</div>
